...
#define shake128_absorb(STATE, INPUT, INLEN) shake128_absorb_ctx(STATE, INPUT, INLEN)
#define xof_squeezeblocks(OUT, OUTBLOCKS, STATE) shake128_squeezeblocks_ctx(OUT, OUTBLOCKS, STATE)
